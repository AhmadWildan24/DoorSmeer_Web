...
const DashBoard: React.FC = () => {
  ...
  return (
    <div>
      <NavBar />
      <div className="pl-44 pt-14">
        <div className="flex">
          <div>
            <h1>SELAMAT DATANG DI ALLOYSMEER</h1>
            <p className="text-[32px] leading-[35px] workSans font-[700]">
          ...
          <div className="">
            <img className="w-[100px] h-[100px] justify-self-end" src={carWash} alt="" />
          </div>
        </div>
        <div className="py-4 justify-items-center">
          ...
          <Layanan />
          <div className="flex flex-col lg:flex-row mt-32 border w-full lg:w-[1350px] h-auto lg:h-[400px] bg-gradient-to-r from-[#0D84BF] to-[#5BC1F4] rounded-tl-[50px] lg:rounded-tl-[100px] rounded-bl-[50px] lg:rounded-bl-[100px] justify-self-end">
            {/* Konten Teks */}
            <div className="pt-8 px-6 md:pt-[50px] md:pl-[50px] lg:pl-[110px] flex-1">
            ...
            <div className="flex justify-center lg:justify-end mt-6 lg:mt-0">
              <img className="w-[90%] md:w-[750px]" src={mobil} alt="Kendaraan" />
            </div>
          </div>
          <AntrianUser />
